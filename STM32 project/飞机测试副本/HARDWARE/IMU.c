...
void UART2_Get_Motion(void)
{
	...
	ax=(signed int)(temp-32768.0)*2/32768.0;//加速度计 X轴的加速度值
	...
	ay=(signed int)(temp-32768.0)*2/32768.0;//加速度计 Y轴的加速度值
	...
	az=(signed int)(temp-32768.0)*2/32768.0;//加速度计 Z轴的加速度值
	...
	gx=((float)temp)/32.8;//陀螺仪 X轴的ADC值
	...
	gy=((float)temp)/32.8;//陀螺仪 Y轴的ADC值
	...
	gz=((float)temp)/32.8;//陀螺仪 Z轴的ADC值
